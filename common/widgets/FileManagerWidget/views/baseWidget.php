...
<div class="fmw-container panel panel-default" id="<?= $widgetId?>">
    ...
    <div class="panel-body fmw-content">
        ...
        <div class="fmw-messageBox" id="<?= $widgetId?>-messageBox">
            <?php if(empty($savedFiles)): ?>
                <div class="fmw-message alert alert-info">Not found any file</div>
            <?php endif; ?>
        </div>
    ...
    <div class="panel-footer">
        <div class="form-group fmw-input">
            <input type="file" name="<?= FileManager::getInstance()->getAttributeName()?>" class="form-control" id="<?= $widgetId?>-input" placeholder="Choose file">
